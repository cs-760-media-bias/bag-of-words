...
simplified = df.sample(frac=0.10)
...
#y= bow_ed["tweetSource"]
y = bow_ed[["ad_fontes_x", "ad_fontes_y", "retweet_count", "favorite_count"]]
X = bow_ed.drop(["id", "tweetSource", "reply_to_screen_name", "reply_to_tweet_id", "reply_to_user_id", "text", "urls", "user_mentions", "hashtags", "tweetTime", "index"], axis=1)
